      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 leading-tight">
            Redefining the Future of <span className="text-brand-green">Retail.</span>
          </h1>
          <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
            <p>
              The Tomorrow Deals started with a simple vision: to make high-quality products 
              accessible to everyone through innovation and customer-centric financial solutions.
            </p>
            <p>
              We curate the best electronics, fashion, and home goods, ensuring that every item 
              meets our strict quality standards. Our team works tirelessly to bring you 
              exclusive deals that you won't find anywhere else.
            </p>
            <p>
              Beyond just a store, we are a community that values trust, transparency, and 
              the excitement of discovering something new every day.
            </p>
          </div>
