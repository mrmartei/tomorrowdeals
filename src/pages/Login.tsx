    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      >
        <div className="text-center mb-6">
          <div className="w-12 h-12 bg-brand-red/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
...
const DemoRoleButton: React.FC<{ 
  ...
  <button
    onClick={onClick}
    disabled={loading}
    className="w-full flex items-center gap-4 p-3 bg-gray-50 rounded-xl border-2 border-transparent hover:border-brand-red/20 hover:bg-white transition-all group disabled:opacity-50"
  >
    <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:bg-brand-red/10 transition-colors">
      {React.cloneElement(icon as React.ReactElement, { className: "w-5 h-5 text-gray-400 group-hover:text-brand-red transition-colors" })}
    </div>
