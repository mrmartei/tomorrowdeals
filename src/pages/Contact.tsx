    ...
    <div className="container-custom py-12 sm:py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          <form className="space-y-4 bg-gray-50 p-6 sm:p-10 rounded-[32px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-white border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-brand-green transition-all"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-white border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-brand-green transition-all resize-none"
              />
            </div>
            <button className="w-full bg-brand-green text-white py-4 rounded-2xl font-bold text-sm hover:bg-brand-green/90 transition-all shadow-sm">
              Send Message
            </button>
          </form>
        </div>
